...
class MODEL_EXPORT SWOFModel : public QAbstractTableModel
{
    Q_OBJECT
    Q_ENUMS(Columns)
public:
    explicit SWOFModel(ProjectData *projectData, QObject *parent = nullptr);

    enum Columns { SWOFSw, SWOFKrW, SWOFKrO, SWOFPcOW };
