...
class MODEL_EXPORT PVTGModel : public QAbstractTableModel
{
    Q_OBJECT
    Q_ENUMS(Columns)
public:
    explicit PVTGModel(ProjectData *projectData, QObject *parent = nullptr);

    enum Columns { PVTGPG, PVTGBG, PVTGMG };
