#ifndef WCONINJEMODEL_H
#define WCONINJEMODEL_H
...
class MODEL_EXPORT WCONINJEModel : public QAbstractItemModel
{
    Q_OBJECT
    Q_ENUMS(Columns)
public:
    explicit WCONINJEModel(ProjectData *projectData, WELSPECSModel *welspecs, QObject *parent = nullptr);

    enum Columns { WellName, WellDate, WellInjFluid, WellStatus, WellControl, WellRATE, WellRESV, WellBHP };
